...
namespace CDS.Framework.Tools.NAntConsole.NAntConsoleTasks.Tasks.NAntContrib
{
    ...
    public class ConcatTask : Task
    {
        ...
        private NAnt.Core.Types.FileSet _fileset = new NAnt.Core.Types.FileSet();
        ...
        public NAnt.Core.Types.FileSet FileSet
        {
            get { return _fileset; }
            set { _fileset = value; }
        }
        ...
        protected override void Initialize()
        {
            ...
            {
                throw new BuildException("Concat fileset cannot be empty!", this.Location);
            }
        }

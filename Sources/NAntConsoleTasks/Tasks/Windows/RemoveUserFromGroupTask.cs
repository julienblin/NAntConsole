...
{
    [TaskName("remove-userfromgroup")]
    class RemoveUserFromGroupTask : Task
    {
        ...
        protected override void ExecuteTask()
        {
            ...
            RemoveUserFromLocalGroup(UserName, GroupName, DomainName, MachineName);
        }

        protected bool RemoveUserFromLocalGroup(string user, string groupName, string domainName, string machine)
        {
            bool reponse = false;
